...
const { delete_architech_by_id, update_architech_by_id, fetch_next_architech, fetch_previous_architech, filter_architechs } = require('../controllers/Architect.controllers')
