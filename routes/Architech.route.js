...
const { update_architech_by_id, fetch_next_architech, fetch_previous_architech, filter_architechs, getArchitectById, fetch_all_architech, delete_multiple_architechs, fetch_architech_by_pagination, getArchitectProfileById, dynamic_architech_data } = require('../controllers/Architect.controllers')
...
architech_router.put('/update', upload.fields([{ name: "profile_url", maxCount: 1 },{ name: "company_brochure_url", maxCount: 1 }]), protect, update_architech_by_id)
